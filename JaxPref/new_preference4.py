...
class ChessDataset(Dataset):
    def __init__(self, data_dir1, data_dir2, len_query=8, batch_size=256):
    ...
    def __getitem__(self, idx):
        ...
        return combine(prep_batch1, prep_batch2, 'intermediate')
...
def main(_):
    ...
    trn_data_dir1 = "/media/hail/HDD/inter_swap_A"
    trn_data_dir2 = "/media/hail/HDD/inter_swap_B"

    eval_data_dir1 = "/media/hail/HDD/inter_swap_Ae"
    eval_data_dir2 = "/media/hail/HDD/inter_swap_Be"
    ...
    dataset = ChessDataset(trn_data_dir1, trn_data_dir2, 8)
    dataset_ = ChessDataset(eval_data_dir1, eval_data_dir2, 8)
    ...
    for epoch in range(FLAGS.n_epochs + 1):
        ...
        if epoch % FLAGS.eval_period == 0:
            for j in range(eval_interval):
                eval_start_pt, eval_end_pt = j * FLAGS.batch_size, min((j + 1) * FLAGS.batch_size, 5000)
