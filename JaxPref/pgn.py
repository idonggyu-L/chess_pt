...
if __name__ == '__main__':
    ...
    eval_data_dir1 = "/media/hail/HDD/chess_data_/classical/new_A"
    eval_data_dir2 = "/media/hail/HDD/chess_data_/classical/new_B"

    shuffled_idx = [i for i in range(64)]
    dataset = ChessDataset(eval_data_dir1,eval_data_dir1,5)
