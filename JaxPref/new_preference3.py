...
class ChessDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return combine(prep_batch1, prep_batch2, 'beginner')
...
def main(_):
    ...
    trn_data_dir1 = "/media/hail/HDD/begin_swap_A"
    trn_data_dir2 = "/media/hail/HDD/begin_swap_B"

    eval_data_dir1 = "/media/hail/HDD/begin_swap_Ae"
    eval_data_dir2 = "/media/hail/HDD/begin_swap_Be"
