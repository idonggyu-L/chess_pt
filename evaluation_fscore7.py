...
def evaluate_model(model):
    ...
    eval_data_dir1 = '/media/hail/HDD/chess_data/f_score/f1_all_c'
    # eval_data_dir2 = '/home/hail/chess_pt/data_1/f2'
    env = Chess()

    dataset_ = ChessDataset(eval_data_dir1, env, 50, 200)
    ...
    true_labels = (labels[:, 0] >= 0.5).astype(int)

    mask = np.abs(labels[:, 0] - labels[:,1]) >= 0.2

    masked_preds = np.array(preds)[mask]
...
if __name__ == "__main__":
    model_path = "/home/hail/Desktop/chess_pt/JaxPref/reward_model/chess/PrefTransformer/soft_classical/s5/model.pkl"
