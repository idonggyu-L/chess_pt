...
intermediate_dir = os.path.join(base_dir, "intermediate_e")
beginner_dir = os.path.join(base_dir, "beginner_e")

mixed_dir = os.path.join(base_dir, "mixed")
mix_pairs = {
    "exp_int_e": [expert_dir, intermediate_dir],
    "int_beg_e": [intermediate_dir, beginner_dir],
    "exp_beg_e": [expert_dir, beginner_dir]
}
