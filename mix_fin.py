...
begin_dir = os.path.join(base_dir, "beginner")

mix_exp = os.path.join(base_dir, "mixed", "exp_beg")     # expert+beginner
mix_int = os.path.join(base_dir, "mixed", "int_beg")     # inter+beginner
mix_beg = os.path.join(base_dir, "mixed", "exp_int")     # expert+intermediate

output_dirs = {
    "expert": [os.path.join(base_dir, "expert_swap_A"), os.path.join(base_dir, "expert_swap_B")],
    "inter": [os.path.join(base_dir, "inter_swap_A"), os.path.join(base_dir, "inter_swap_B")],
    "begin": [os.path.join(base_dir, "begin_swap_A"), os.path.join(base_dir, "begin_swap_B")]
}
