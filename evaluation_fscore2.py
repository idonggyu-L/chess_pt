...
def evaluate_model(model):
    ...
    eval_data_dir1 = '/media/hail/HDD/chess_data/f_score/f1_cem'
    eval_data_dir2 = '/media/hail/HDD/chess_data/f_score/f2_cem'
    env = Chess()
    ...
    print(f"Evaluation Result Accuracy: {acc:.4f}, F1-score: {f1:.4f}, Classical_expert_intermediate")
    return acc, f1

# === Main ===
if __name__ == "__main__":
    model_path = "/home/hail/Desktop/chess_pt/JaxPref/reward_model/chess/PrefTransformer/group_expert_intermediate/s5/model.pkl"
